													...
													<td class="text-center">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="kirim/{{$prod->id}}/{{$prod->produk->id}} " class="menu-link px-3">Kirim</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="destroyproduct/{{$prod->id}} " class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">Tolak</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
