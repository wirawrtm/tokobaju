		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(../assets/media/illustrations/sketchy-1/14-dark.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="../../demo1/dark/index.html" class="mb-12">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" method="POST" action="storeuser" enctype="multipart/form-data">
							@csrf
							<!--begin::Heading-->
							...
							<div class="row fv-row mb-7">
								...
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Name Shop</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="namatoko" autocomplete="off" />
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							...
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid" type="password" placeholder="" name="password1" autocomplete="off" />
							...
							<div class="fv-row mb-5">
								...
								<input class="form-control form-control-lg form-control-solid" type="password" placeholder="" name="password2" autocomplete="off" />
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
